...
export const CivicFooter: React.FC<CivicFooterProps> = ({ onSelectAdminTab }) => {
  ...
  return (
    <footer className="bg-[#1c1917] text-stone-300 border-t border-[#292524] text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs text-stone-400">
              <div className="flex items-start gap-2">
                <Clock className="w-4 h-4 text-[#b58a3a] mt-0.5 shrink-0" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 text-xs text-stone-400">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#b58a3a] mt-0.5 shrink-0" />
                <span>Avenida Central, entre Calles 2 y 4, Costado Norte del Parque Central.</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-[#b58a3a] shrink-0" />
                <span>Boletería: +506 2440-1912</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-[#b58a3a] shrink-0" />
        ...
        {/* Colophon */}
        <div className="mt-16 pt-8 border-t border-[#292524] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-500">
          ...
          <div className="flex items-center gap-6">
            {onSelectAdminTab && (
              ...
              >
                <Shield className="w-3.5 h-3.5 text-[#b58a3a]" /> Portal de Operadores
              </button>
            )}
            <button
              onClick={scrollToTop}
