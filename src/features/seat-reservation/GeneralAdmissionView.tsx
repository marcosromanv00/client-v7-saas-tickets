...
export function GeneralAdmissionView({
  ...
  return (
    <div className="bg-white dark:bg-[#0b1a30] rounded-3xl border border-slate-200 dark:border-teatro-navy-border p-6 sm:p-7 shadow-sm space-y-6 text-left transition-colors">
      <div className="border-b border-slate-200 dark:border-teatro-navy-border pb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div
          ...
          className={`p-5 rounded-2xl border-2 cursor-pointer transition-all duration-150 ${
            selectedZone === "PLANTA_BAJA"
              ? "border-teatro-blue dark:border-blue-500 bg-teatro-blue-light dark:bg-teatro-blue/20 shadow-xs ring-2 ring-teatro-blue/20"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-[11px]">
              <span className="text-slate-500 dark:text-slate-400 flex items-center gap-1 font-mono">
                <Users className="w-3 h-3 text-teatro-blue dark:text-blue-400" /> Disponibles:
              </span>
        ...
        <div
          ...
          className={`p-5 rounded-2xl border-2 cursor-pointer transition-all duration-150 ${
            selectedZone === "BALCON"
              ? "border-teatro-gold dark:border-amber-400 bg-amber-50/60 dark:bg-amber-500/10 shadow-xs ring-2 ring-teatro-gold/20"
              : "border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#071324] hover:border-slate-300 dark:hover:border-slate-700"
          }`}
        >
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <Armchair className="w-5 h-5 text-teatro-gold dark:text-amber-400" />
              <h4 className="text-sm font-semibold text-slate-900 dark:text-white">Balcón • Segunda Planta</h4>
            </div>
            <span className={`text-[10px] font-mono px-2 py-0.5 rounded-full font-semibold ${
              selectedZone === "BALCON"
                ? "bg-teatro-gold text-white"
                : "bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400"
            }`}>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-[11px]">
              <span className="text-slate-500 dark:text-slate-400 flex items-center gap-1 font-mono">
                <Users className="w-3 h-3 text-teatro-gold dark:text-amber-400" /> Disponibles:
              </span>
              <span className="font-mono text-slate-900 dark:text-white font-medium">
            ...
            <div className="w-full bg-slate-200 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden">
              <div
                className="bg-teatro-gold dark:bg-amber-400 h-full transition-all duration-300"
