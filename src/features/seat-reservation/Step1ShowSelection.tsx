...
export const Step1ShowSelection: React.FC<Step1ShowSelectionProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="relative rounded-3xl overflow-hidden border border-slate-200 dark:border-[#1e355b] bg-white dark:bg-[#0b1a30] shadow-md transition-colors">
        <div className="relative h-64 sm:h-80 md:h-96 w-full overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-1 rounded-full text-[11px] font-bold bg-white/95 text-[#004ea2] shadow-xs">
                {selectedEvent.genre}
              </span>
              {selectedEvent.isPrivate ? (
                ...
                <span className="px-2.5 py-1 rounded-full text-[11px] font-bold bg-[#c8102e] text-white shadow-xs">
                  Entrada Libre
                </span>
              )}
              <span className="flex items-center gap-1 text-[11px] text-slate-200 bg-black/45 px-2.5 py-1 rounded-full backdrop-blur-md">
                <Clock className="w-3 h-3 text-[#c59223]" /> {selectedEvent.durationMinutes} min
              </span>
            </div>
        ...
        <div className="p-6 sm:p-8 bg-white dark:bg-[#0b1a30] border-t border-slate-200 dark:border-[#1e355b] space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Calendar className="w-4 h-4 text-[#004ea2] dark:text-blue-400" />
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center min-w-[70px] sm:min-w-[80px] py-3 px-2 rounded-2xl border transition-all cursor-pointer ${
                      isSelected
                        ? "bg-[#004ea2] border-[#003c80] text-white shadow-md shadow-blue-900/25 scale-105"
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Clock className="w-4 h-4 text-[#004ea2] dark:text-blue-400" />
              <h3 className="text-xs font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider">
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-mono font-semibold transition-all cursor-pointer ${
                      isSelected
                        ? "bg-[#004ea2] text-white shadow-xs scale-105 border border-[#003c80]"
          ...
          <div className="pt-2">
            <motion.button
              ...
              className="w-full sm:w-auto px-8 py-3.5 bg-[#c8102e] hover:bg-[#a60c25] text-white font-semibold rounded-2xl text-sm flex items-center justify-center gap-3 shadow-lg shadow-red-900/20 transition-all cursor-pointer"
            >
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-[#c59223] dark:text-amber-400 font-mono">Temporada 2026</span>
        </div>
            ...
            return (
              <div
                ...
                className={`group p-3 rounded-2xl border transition-all cursor-pointer flex items-center gap-3.5 ${
                  isCurrent
                    ? "bg-[#ebf3fc] dark:bg-[#004ea2]/20 border-[#004ea2] dark:border-blue-500/40 shadow-xs"
                    : "bg-white dark:bg-[#0b1a30] border-slate-200 dark:border-[#1e355b] hover:border-slate-300 dark:hover:border-slate-600"
                }`}
              >
                <img
                  src={evt.posterUrl}
                ...
                <div className="space-y-1 min-w-0">
                  <h3 className="text-xs font-semibold text-slate-900 dark:text-slate-100 group-hover:text-[#004ea2] dark:group-hover:text-blue-400 transition-colors truncate">
                    {evt.title}
                  </h3>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 truncate">{evt.genre}</p>
                  <p className="text-[10px] text-[#004ea2] dark:text-blue-400 font-mono">
