...
export function SpecialGuestsManager({ event }: SpecialGuestsManagerProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#0b1a30] rounded-3xl border border-slate-200 dark:border-teatro-navy-border p-6 shadow-sm space-y-5 text-left transition-colors">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 dark:border-teatro-navy-border pb-4">
        <div>
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-teatro-blue dark:text-blue-400" />
        ...
        <button
          ...
          className="px-4 py-2 bg-teatro-blue hover:bg-teatro-blue-hover text-white font-semibold rounded-xl text-xs flex items-center gap-1.5 transition-colors self-start sm:self-auto shadow-xs cursor-pointer"
        >
      ...
      {isAdding && (
        <form onSubmit={handleAddGuest} className="p-5 bg-slate-50 dark:bg-[#071324] rounded-2xl border border-slate-200 dark:border-[#1a3357] space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white dark:bg-[#0b1a30] border border-slate-200 dark:border-teatro-navy-border rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none focus:border-teatro-blue"
              />
            </div>
            <div>
              <label className="block text-[11px] font-mono text-slate-700 dark:text-slate-300 mb-1">
          ...
          <div className="flex justify-end gap-2 pt-1">
            <button
              type="submit"
              className="px-4 py-2 bg-muni-red hover:bg-muni-red-hover text-white font-semibold rounded-xl text-xs transition-colors cursor-pointer"
            >
            ...
            <div key={guest.id} className="py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-teatro-blue-light dark:bg-teatro-blue/20 text-teatro-blue dark:text-blue-300 border border-teatro-blue/30 font-mono text-[10px] font-semibold">
              ...
              <div>
                ...
                >
                  <Ticket className="w-3.5 h-3.5 text-teatro-blue dark:text-blue-400" />
